...
namespace CMCL.Wpf.UserControl
{
    ...
    public partial class MainTabUc : System.Windows.Controls.UserControl
    {
        ...
        private async void StartGameBtnClick(object sender, RoutedEventArgs e)
        {
            ...
            var loadingFrm = LoadingFrm.GetInstance(GlobalStaticResource.LoadingFrmDataContext, System.Windows.Window.GetWindow(this));
            ...
            {
                if (!startResult) Dispatcher.BeginInvoke(new Action(() => { btn.IsEnabled = true; }));
