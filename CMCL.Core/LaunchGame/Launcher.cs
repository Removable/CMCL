...
namespace CMCL.Core.LaunchGame
{
    public sealed class Launcher
    {
        private CmclConfig _config;
        ...
        private bool ConfigCheck(out string msg)
        {
            ...
            //Java安装
            if (string.IsNullOrWhiteSpace(_config.CustomJavaPath) || !System.IO.File.Exists(_config.CustomJavaPath))
            {
